...
os.system('allure generate OutPuts/reports -o reports/html --clean')#生成测试报告，将json文件生成报告保存在指定目录(OutPuts/reports)下,allure generate 测试结果数据所在目录 -o 测试报告保存的目录   --clean
